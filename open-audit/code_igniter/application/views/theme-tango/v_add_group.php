...
<legend><span style="font-size: 12pt;">&nbsp;<?php echo __("Group Selection Details")?></span></legend>
	<fieldset id="group_selection" class="niceforms">
		...
		<span id='dynamic_type_other'>
			...
			&nbsp;&nbsp;&nbsp;NOTE - When using 'like', % (percent) symbols are not needed.
			...
			<select id='dynamic_field_value' name='dynamic_field_value'>
					<option value='' selected='selected'>Choose a field value from the list</option>
			</select>
...
<p>
<?php echo form_submit('Add', 'Add Group'); ?><?php echo $this->session->flashdata('message'); ?><br />&nbsp;</p>
<?php echo form_close(); ?>
