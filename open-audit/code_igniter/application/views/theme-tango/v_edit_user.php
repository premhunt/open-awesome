...
function group_dropdown ($group_id, $access_level)
{
	...
	if ( $access_level == '0' )  { $option_0 =  "<option value='0' selected=\"selected\">";  } else { $option_0 = "<option value='0'>"; }
	if ( $access_level == '3' )  { $option_3 =  "<option value='3' selected=\"selected\">";  } else { $option_3 = "<option value='3'>"; }
	if ( $access_level == '5' )  { $option_5 =  "<option value='5' selected=\"selected\">";  } else { $option_5 = "<option value='5'>"; }
	if ( $access_level == '7' )  { $option_7 =  "<option value='7' selected=\"selected\">";  } else { $option_7 = "<option value='7'>"; }
	if ( $access_level == '10' ) { $option_10 = "<option value='10' selected=\"selected\">"; } else { $option_10 = "<option value='10'>"; }
...
function alter_all_groups() {
	...
	<?php $count = 0; echo "\n";
	foreach($user_group as $key) {
		$count++; echo "	totalArray[$count] = " . $key->group_id . "\n";
	} ?>
	var i=1;
